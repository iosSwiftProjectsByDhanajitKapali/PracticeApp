...
class PaginationDemoViewController: UIViewController {
...
extension PaginationDemoViewController {
...
extension PaginationDemoViewController {
    private func fetchData() {
        ...
        PaginationDemoAPIService().getData(pageNo: curretnPage) { res in
            switch res {
...
extension PaginationDemoViewController: UITableViewDataSource {
...
extension PaginationDemoViewController: UITableViewDelegate {
...
// MARK: - PaginationDemoAPIService
class PaginationDemoAPIService {
